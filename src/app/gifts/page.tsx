      ...
      <div className="my-10 grid items-center gap-10 lg:my-0 lg:min-h-[calc(100vh-80px)] lg:grid-cols-2">
        <div>
          ...
          <p className="mb-8 text-sm">
            ...
            suas preferências e possibilidades. Preparamos uma seleção de
            produtos que precisamos na nossa nova casinha. Além disso, pensando
            em facilitar a contribuição para aqueles que preferem presentear de
