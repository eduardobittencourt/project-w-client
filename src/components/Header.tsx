...
export default function Header() {
  return (
    <header className="lg:px-8 mx-auto flex items-center justify-between py-6">
      ...
      <nav className="fixed right-0 top-0 z-10 grid h-screen translate-x-full content-start gap-4 border-l bg-white p-8 font-serif transition-transform peer-checked:translate-x-0 tablet:static tablet:h-auto tablet:translate-x-0 tablet:grid-flow-col tablet:border-l-0 tablet:p-0">
        <label
          htmlFor="menu"
          className="mb-4 cursor-pointer justify-self-end p-4 tablet:hidden"
        >
          <svg
